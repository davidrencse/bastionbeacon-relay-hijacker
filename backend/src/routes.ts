...
const routeDefinitions: RouteDefinition[] = [
  {
    "method": "get",
    "path": "/health",
    "purpose": "Returns service status and confirms the backend is running in simulation mode.",
    "response_shape": {
      "status": "ok",
      "service": "bastionbeacon-relay-hijacker-api",
      "simulationOnly": true,
      "version": "string"
    }
  },
  {
    "method": "get",
    "path": "/scenarios",
    "purpose": "Lists available synthetic relay takeover scenarios.",
    "response_shape": {
  ...
  },
  {
    ...
    "purpose": "Returns the complete definition of a selected synthetic scenario.",
    "response_shape": {
  ...
  },
  {
    "method": "post",
    "path": "/simulations",
    "purpose": "Creates a new in-memory simulation session from a selected scenario.",
    "response_shape": {
  ...
  },
  {
    ...
    "purpose": "Returns the current simulation session state.",
    "response_shape": {
      "session": "SimulationSession"
    }
  },
  {
    "method": "post",
    "path": "/simulations/:sessionId/advance",
    "purpose": "Advances the synthetic simulation by one or more scripted events.",
    "response_shape": {
      "session": "SimulationSession",
  ...
  {
    "method": "post",
    "path": "/simulations/:sessionId/playback",
    "purpose": "Changes playback state without executing asynchronous attack logic.",
    "response_shape": {
      "session": "SimulationSession"
    }
  },
  {
    "method": "post",
    "path": "/simulations/:sessionId/takeover",
    "purpose": "Applies the controlled simulation-only relay reroute to session state.",
    "response_shape": {
      "session": "SimulationSession",
      "takeoverEvent": "SimulationEvent"
    }
  },
  {
    "method": "post",
    "path": "/simulations/:sessionId/reset",
    "purpose": "Resets a simulation session to its starting state.",
    "response_shape": {
      "session": "SimulationSession"
    }
  },
  {
    "method": "post",
    "path": "/simulations/:sessionId/rerun",
    "purpose": "Creates a fresh deterministic or bounded randomized replay for the same scenario.",
    "response_shape": {
      "session": "SimulationSession"
    }
  },
  {
    "method": "get",
    "path": "/simulations/:sessionId/brief",
    "purpose": "Builds an exportable incident brief for the simulation.",
    "response_shape": {
      "brief": "IncidentBrief"
    }
  }
